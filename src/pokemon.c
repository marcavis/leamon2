...
static const enum NationalDexOrder sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(CADELAIDE),
    HOENN_TO_NATIONAL(ADELAIDE),
    HOENN_TO_NATIONAL(EADELAIDE),
};
...
#include "data/pokemon/level_up_learnsets/leamon_learnsets.h"
