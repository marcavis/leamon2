...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_GLAD_HANDING = 319,
    ABILITY_NEST_DEFENDER = 320,
    ABILITIES_COUNT_GEN9,

    //Leamon abilities
    ABILITY_HIGH_MOHS = ABILITIES_COUNT_GEN9,
    ABILITY_TURBO_CLAW = 322,
    ABILITY_OPPRESSION_AURA = 323,
    ABILITIES_COUNT_LEAMON = ABILITIES_COUNT_GEN9 + 3,
    ABILITIES_COUNT = ABILITIES_COUNT_LEAMON,
};
