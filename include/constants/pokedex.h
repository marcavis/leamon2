...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_LEA,
    NATIONAL_DEX_KARIN,
    NATIONAL_DEX_CZEPHYRA,
    NATIONAL_DEX_EZEPHYRA,
    ...
    NATIONAL_DEX_RENSA,
    NATIONAL_DEX_ERENSA,
    NATIONAL_DEX_LUCILLER,
    NATIONAL_DEX_ELUCILLER,
};

#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_GEN_9_POKEMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_ELUCILLER
...
#define HOENN_DEX_COUNT (HOENN_DEX_ELUCILLER + 1)
